...
# ───────────────────────────────────────────────────────────────────────────────
customers    = pd.read_csv(CUSTOMER_PATH, sep='|', encoding='latin1')
orderheader  = pd.read_csv(PRODUCT_PATH, sep='|', encoding='latin1')
orderdetails = pd.read_csv(ORDERHEADER_PATH, sep='|', encoding='latin1')
product      = pd.read_csv(ORDERDETAILS_PATH, sep='|', encoding='latin1')
